    ...
    <div class="container">
        ...
        <form action="{{ route('company-details.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="inputs tab" id="tab-1">
                ...
                <label>Company Logo
                    <input type="file" name="logo" value="{{ old('logo') }}" accept=".png,.jpg"
                        placeholder="Inter your website logo" />
                </label>
            ...
            <div class="inputs tab" id="tab-2">
                ...
                <label>FB Page Link
                    <input type="url" name="facebook_page_link" value="{{ old('facebook_page_link') }}"
                        placeholder="Inter Your Facebook Page Link" />
                </label>

                <label>Youtube Link
                    <input type="url" name="facebook_group_link" value="{{ old('facebook_group_link') }}"
